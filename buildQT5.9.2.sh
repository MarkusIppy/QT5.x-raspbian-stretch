...
cd /home/pi/qt-everywhere-opensource-src-5.9.2/qtbase/mkspecs/devices/linux-rasp-pi2-g++
sudo rm qmake.conf

# Download modified qmake.conf for Raspberry Pi2
cd /home/pi/QT5.x-raspbian-stretch
sudo cp qmake.conf /home/pi/qt-everywhere-opensource-src-5.9.2/qtbase/mkspecs/devices/linux-rasp-pi2-g++
