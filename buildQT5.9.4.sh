...
# Install QT5.9.4 on rasbian stretch 
cd
...
# Download QT 5.9.4 Source code
wget http://download.qt.io/official_releases/qt/5.9/5.9.4/single/qt-everywhere-opensource-src-5.9.4.tar.xz

# Untar Source code
tar xf qt-everywhere-opensource-src-5.9.4.tar.xz

# Delete source tarball to save some space
sudo rm -r qt-everywhere-opensource-src-5.9.4.tar.xz

# Delete qmake.conf for Raspberry Pi2 
cd /home/pi/qt-everywhere-opensource-src-5.9.4/qtbase/mkspecs/devices/linux-rasp-pi2-g++
sudo rm qmake.conf

# Download modified qmake.conf for Raspberry Pi2
cd /home/pi/QT5.x-raspbian-stretch
sudo cp qmake.conf /home/pi/qt-everywhere-opensource-src-5.9.4/qtbase/mkspecs/devices/linux-rasp-pi2-g++
